...
Переход от legacy-структур к типизированным доменным таблицам дополнительно
регулируется [стратегией dual-write/backfill/cutover/rollback](LEGACY_MIGRATION.md).
